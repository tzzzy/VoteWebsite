...
public interface StaffMapper {
    ...
    @Select("SELECT STAFF_ID, INSTITUTION.INSTITUTION_NAME, INSTITUTION.INSTITUTION_ID, TYPE,STAFF.STAFF_NAME,POSITION FROM STAFF ,INSTITUTION WHERE STAFF_ID <> '123456789' AND STAFF.INSTITUTION <> 'EMPTY' AND STAFF.INSTITUTION = INSTITUTION.INSTITUTION_ID")
    List<StaffManage> findAllExceptEmpty();
